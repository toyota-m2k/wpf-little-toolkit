...
namespace io.github.toyota32k.toolkit.view {
    ...
    /**
     * PropertyChangeNotifier に、Disoposableなプロパティの自動的な解放機能を追加したクラス。
     */
    public class ViewModelBase : PropertyChangeNotifier, INotifyPropertyChanged, IDisposable {
        /**
         * コンストラクタ
    ...
    /**
     * PropertyChangeNotifier に、Disoposableなプロパティの自動的な解放機能と、
     * WeakReferenceなOwnerを保持するための仕掛けを追加した究極のViewModelベースクラス。
     */
    public class ViewModelBase<T> : ViewModelBase, INotifyPropertyChanged, IDisposable where T : class {
